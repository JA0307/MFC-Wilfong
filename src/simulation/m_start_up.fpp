...
contains
    ...
    impure subroutine s_save_data(t_step, start, finish, io_time_avg, nt)
        ...
        if (bubbles_lagrange) then
            ...
            ! do i = 1, n_el_particles_loc if (ieee_is_nan(particle_rad(i, 1)) .or. particle_rad(i, 1) <= 0._wp) then call
            ! s_mpi_abort("Particle radius is negative or NaN, please reduce dt.") end if end do
